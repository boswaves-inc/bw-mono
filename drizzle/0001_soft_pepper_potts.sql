...
CREATE TABLE "item_price" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "item_price_item_currency_unq" UNIQUE("item_id", "currency_code", "period", "period_unit")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "cart_item"
ADD CONSTRAINT "cart_item_item_item_id_fk" FOREIGN KEY ("item") REFERENCES "public"."item"("id") ON DELETE cascade ON UPDATE cascade;
--> statement-breakpoint
ALTER TABLE "cart_item"
ADD CONSTRAINT "cart_item_item_price_item_price_id_fk" FOREIGN KEY ("item_price") REFERENCES "public"."item_price"("id") ON DELETE cascade ON UPDATE cascade;
--> statement-breakpoint
ALTER TABLE "item_coupon"
ADD CONSTRAINT "item_coupon_id_item_id_fk" FOREIGN KEY ("id") REFERENCES "public"."item"("id") ON DELETE cascade ON UPDATE cascade;
--> statement-breakpoint
ALTER TABLE "item_price"
ADD CONSTRAINT "item_price_item_id_item_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."item"("id") ON DELETE cascade ON UPDATE cascade;
--> statement-breakpoint
ALTER TABLE "item_script"
ADD CONSTRAINT "item_script_id_item_id_fk" FOREIGN KEY ("id") REFERENCES "public"."item"("id") ON DELETE cascade ON UPDATE cascade;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_slug_unq" ON "item" USING btree ("slug");
--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_name_unq" ON "item" USING btree ("name")
WHERE status != 'deleted';
--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_id_type_unq" ON "item" USING btree ("id", "type")
WHERE status != 'deleted';
--> statement-breakpoint
CREATE INDEX "item_price_item_idx" ON "item_price" USING btree ("item_id");
--> statement-breakpoint
CREATE INDEX "item_price_currency_idx" ON "item_price" USING btree ("currency_code");
--> statement-breakpoint
CREATE INDEX "item_price_item_currency_idx" ON "item_price" USING btree ("item_id", "currency_code", "period", "period_unit");
--> statement-breakpoint
CREATE INDEX "item_script_uuid_idx" ON "item_script" USING btree ("uuid");
--> statement-breakpoint
CREATE INDEX "item_script_id_idx" ON "item_script" USING btree ("id");
--> statement-breakpoint
CREATE VIEW "public"."cart_data" AS (
	...
	from "cart_info"
		...
		inner join "item" on "cart_item"."item" = "item"."id"
