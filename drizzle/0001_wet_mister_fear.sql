...
CREATE TABLE "item_tag" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "item_tag_item_id_id_pk" PRIMARY KEY("item_id","id")
);
--> statement-breakpoint
CREATE TABLE "script" (
	"id" uuid PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX "item_tag_item_id_unq" ON "item_tag" USING btree ("item_id","id") WHERE status != 'deleted';--> statement-breakpoint
