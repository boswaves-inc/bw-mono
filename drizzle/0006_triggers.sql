...
$$ LANGUAGE plpgsql;
--> statement-breakpoint
DROP TRIGGER IF EXISTS refresh_plan_data_trggr ON item;
--> statement-breakpoint
DROP TRIGGER IF EXISTS refresh_plan_data_trggr ON item_plan_price;
--> statement-breakpoint
DROP TRIGGER IF EXISTS refresh_plan_data_trggr ON item_plan_script;
--> statement-breakpoint
...
INSERT
    OR
UPDATE
    OR DELETE ON item FOR EACH STATEMENT EXECUTE FUNCTION refresh_plan_data();
--> statement-breakpoint
CREATE TRIGGER refresh_plan_data_trggr
AFTER
INSERT
