...
export const ItemPriceModel = pgEnum('item_price_model', [
    'flat_fee',
    'per_unit'
])

export const Item = pgTable("items", (t) => ({
...
export const ItemPrice = pgTable('item_prices', (t) => ({
    id: t.uuid().notNull().primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const ItemScript = pgTable("item_scripts", (t) => ({
...
export const ItemTag = pgTable("item_tags", (t) => ({
...
export type ItemPriceModel = InferEnum<typeof ItemPriceModel>
