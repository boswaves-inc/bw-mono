...
export const Checkbox = forwardRef<HTMLElement, HeadlessProps<InternalProps>>(({ children, className, ...props }, ref) => (
    <Internal {...props} ref={ref} className={twMerge('group p-0.25 size-4 rounded-sm relative border border-gray-300 focus:not-data-focus:outline-none data-checked:bg-blue-500 data-focus:outline data-focus:outline-offset-2 data-focus:outline-blue-500', className)} >
