...
export const Marker = ({ src, top, offset, delay, }: MarkerProps) => (
    <motion.div
    ...
    >
        ...
        <img alt="" src={src} className="absolute top-1 left-[7px] size-6 rounded-full" />
    </motion.div>
)

export const Atlas = () => (
    <div aria-hidden="true" className="relative size-full">
        <div className="absolute inset-0 bg-[url(/atlas/base.png)] mask-[linear-gradient(to_bottom,black_50%,transparent)] bg-size-[530px_430px] bg-position-[center_-75px] bg-no-repeat" />
        <div className="absolute inset-0">
            <Marker src="/atlas/1.jpg" top={96} offset={-128} delay={0.15} />
            <Marker src="/atlas/2.jpg" top={160} offset={-16} delay={0.4} />
            <Marker src="/atlas/3.jpg" top={144} offset={96} delay={0.3} />
            <Marker src="/atlas/4.jpg" top={192} offset={64} delay={0.6} />
            <Marker src="/atlas/5.jpg" top={224} offset={-32} delay={0.8} />
        </div>
    </div>
)