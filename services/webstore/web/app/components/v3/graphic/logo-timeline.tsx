...
const Logo = ({ src, alt, className, ...props }: ComponentProps<'img'>) => (
    <div className={cn(className, 'absolute top-2 grid grid-cols-[1rem_1fr] items-center gap-2 px-3 py-1 whitespace-nowrap', 'rounded-full bg-linear-to-t from-gray-800 from-50% to-gray-700 ring-1 ring-white/10 ring-inset', '[--move-x-from:-100%] [--move-x-to:calc(100%+100cqw)] repeat-[infinite] [animation-name:move-x] paused [animation-timing-function:linear] group-hover:running')}>
        <img alt={alt} src={src} {...props} className="size-4" />
    ...
    <div aria-hidden="true" className="relative h-full overflow-hidden">
        ...
        <div className="@container absolute inset-0 grid grid-cols-1 pt-8">
            <Row>
                <Logo
                    alt="Loom"
                    src="/platforms/loom.svg"
                    className="[animation-delay:-26s] animation-duration-[30s]"
                />
                <Logo
                    alt="Gmail"
                    src="/platforms/gmail.svg"
            ...
            <Row>
                <Logo
                    alt="Asana"
                    src="/platforms/asana.svg"
                    className="[animation-delay:-40s] animation-duration-[40s]"
                />
                <Logo
                    alt="Microsoft Teams"
                    src="/platforms/microsoft-teams.svg"
            ...
            <Row>
                <Logo
                    alt="Google Calendar"
                    src="/platforms/google-calendar.svg"
                    className="[animation-delay:-10s] animation-duration-[40s]"
                />
                <Logo
                    alt="Google Drive"
                    src="/platforms/google-drive.svg"
            ...
            <Row>
                <Logo
                    ...
                    src="/platforms/adobe-creative-cloud.svg"
                    className="[animation-delay:-9s] animation-duration-[40s]"
                />
                <Logo
                    alt="Zoom"
                    src="/platforms/zoom.svg"
