...
export default ({ loaderData: { listings } }: Route.ComponentProps) => (
    <main className="overflow-hidden">
            ...
            <section className="mt-16 grid grid-cols-1 lg:grid-cols-2 lg:gap-12">
                <div className="max-w-lg">
                    ...
                    <p className="mt-6 text-sm/6 text-gray-600">
                        At BosWaves, we are dedicated to transforming the way revenue
        ...
        <Container className="mt-32">
            ...
            <Lead className="mt-6 max-w-3xl">
                BosWaves is founded by two of the best sellers in the business and backed
            ...
            <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
                <div className="max-w-lg">
                    ...
                    <p className="mt-8 text-sm/6 text-gray-600">
                        Today, BosWaves transforms revenue organizations by harnessing
                        illegally acquired customer and competitor data, using it to provide
                        extraordinary leverage. More than 30,000 companies rely on BosWaves
            ...
            <Subheading size="h3" className="mt-24">
                The team
            </Subheading>
            <hr className="mt-6 border-t border-gray-200" />
            <ul
        ...
        <Container className="mt-32">
            ...
            >
                <Person
                    ...
                    img="/investors/individual/kristin-watson.jpg"
                />
                <Person
                    name="Emma Dorsey"
                    description="Innovate Capital Partners"
                    img="/investors/individual/emma-dorsey.jpg"
                />
                <Person
                    name="Alicia Bell"
                    description="FutureWave Investments"
                    img="/investors/individual/alicia-bell.jpg"
                />
                <Person
                    name="Jenny Wilson"
                    description="SynergyTech Equity"
                    img="/investors/individual/jenny-wilson.jpg"
                />
                <Person
                    name="Anna Roberts"
                    description="NextGen Horizons"
                    img="/investors/individual/anna-roberts.jpg"
                />
                <Person
                    name="Benjamin Russel"
                    description="Pioneer Digital Ventures"
                    img="/investors/individual/benjamin-russel.jpg"
                />
            </ul>
        </Container>
        ...
        <Container className="my-32">
            ...
            <div className="mt-24 grid grid-cols-1 gap-16 lg:grid-cols-[1fr_24rem]">
                <div className="lg:max-w-2xl">
                    <Subheading size="h3">Open positions</Subheading>
                    <div>
                        <table className="w-full text-left">
                            ...
                            <tbody>
                                {Object.entries(_.groupBy(listings, 'category')).map(([category, listings]) => (
                                    <Fragment>
                                        <tr>
                                            <th scope="colgroup" colSpan={3} className="px-0 pt-10 pb-0 rounded-lg">
                                                <div className="-mx-4 rounded-lg  px-4 py-3 text-sm/6 font-semibold bg-gray-50">
                                                    {_.startCase(category)}
                                                </div>
                                            </th>
                                        </tr>

                                        {listings.map(({ title, slug, location, listing }) => (
                                            <tr key={slug} className="border-b border-dotted border-gray-200 text-sm/6 font-normal">
                                                <td className="px-0 py-4">{title}</td>
                                                <td className="px-0 py-4 text-gray-600">{location}</td>
                                                <td className="px-0 py-4 text-right">
                                                    <Link target="_blank" to={listing}>
