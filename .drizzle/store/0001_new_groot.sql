...
CREATE TYPE "public"."item_price_model" AS ENUM('flat_fee', 'per_unit');--> statement-breakpoint
CREATE TYPE "public"."item_status" AS ENUM('archived', 'deleted', 'active');--> statement-breakpoint
...
CREATE TABLE "coupons" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "coupons_discount_check" CHECK ((discount_type = 'percentage' AND discount_percentage IS NOT NULL) OR (discount_type = 'fixed_amount' AND discount_currency IS NOT NULL AND discount_amount IS NOT NULL)),
	CONSTRAINT "coupons_valid_check" CHECK ((valid_from IS NULL AND valid_till IS NULL) OR (valid_from IS NOT NULL AND valid_till IS NOT NULL and valid_till > valid_from))
);
--> statement-breakpoint
CREATE TABLE "items" (
	"id" uuid PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX "user_otps_active_unique_idx" ON "user_otps" USING btree ("uid","scope") WHERE "user_otps"."consumed_at" IS NULL AND "user_otps"."revoked_at" IS NULL;--> statement-breakpoint
CREATE INDEX "cart_uid_idx" ON "carts" USING btree ("uid");--> statement-breakpoint
CREATE INDEX "cart_coupon_id_idx" ON "cart_coupons" USING btree ("id");--> statement-breakpoint
CREATE INDEX "cart_coupon_item_price_idx" ON "cart_coupons" USING btree ("coupon");--> statement-breakpoint
CREATE UNIQUE INDEX "cart_coupon_id_item_price_idx" ON "cart_coupons" USING btree ("id","coupon");--> statement-breakpoint
CREATE INDEX "cart_item_id_idx" ON "cart_items" USING btree ("id");--> statement-breakpoint
CREATE INDEX "cart_item_item_price_idx" ON "cart_items" USING btree ("item_price");--> statement-breakpoint
CREATE UNIQUE INDEX "cart_item_id_item_price_idx" ON "cart_items" USING btree ("id","item_price");--> statement-breakpoint
CREATE UNIQUE INDEX "coupons_name_unq" ON "coupons" USING btree ("name") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_slug_unq" ON "items" USING btree ("slug") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_name_unq" ON "items" USING btree ("name") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_info_id_type_unq" ON "items" USING btree ("id","type") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_price_name_unq" ON "item_prices" USING btree ("name") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_price_item_currency_idx" ON "item_prices" USING btree ("item_id","currency_code","period","period_unit") WHERE status != 'deleted';--> statement-breakpoint
CREATE INDEX "item_price_currency_idx" ON "item_prices" USING btree ("currency_code");--> statement-breakpoint
CREATE INDEX "item_price_item_idx" ON "item_prices" USING btree ("item_id");--> statement-breakpoint
CREATE INDEX "item_script_uuid_idx" ON "item_scripts" USING btree ("uuid");--> statement-breakpoint
CREATE INDEX "item_script_item_id_idx" ON "item_scripts" USING btree ("item_id");--> statement-breakpoint
CREATE UNIQUE INDEX "item_script_uuid_unq" ON "item_scripts" USING btree ("item_id","uuid");--> statement-breakpoint
CREATE UNIQUE INDEX "item_script_item_id_unq" ON "item_scripts" USING btree ("uuid","id");--> statement-breakpoint
CREATE INDEX "item_tag_id_idx" ON "item_tags" USING btree ("id");--> statement-breakpoint
CREATE INDEX "item_tag_slug_idx" ON "item_tags" USING btree ("slug");--> statement-breakpoint
CREATE INDEX "item_tag_item_id_idx" ON "item_tags" USING btree ("item_id");--> statement-breakpoint
CREATE UNIQUE INDEX "item_tag_item_id_unq" ON "item_tags" USING btree ("item_id") WHERE status != 'deleted';--> statement-breakpoint
CREATE UNIQUE INDEX "item_tag_item_slug_unq" ON "item_tags" USING btree ("item_id","slug") WHERE status != 'deleted';--> statement-breakpoint
CREATE INDEX "script_status_idx" ON "scripts" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "script_uuid_unq" ON "scripts" USING btree ("uuid") WHERE status != 'deleted';--> statement-breakpoint
CREATE INDEX "tag_info_status_idx" ON "tags" USING btree ("status");--> statement-breakpoint
CREATE UNIQUE INDEX "tag_info_slug_unq" ON "tags" USING btree ("slug") WHERE status != 'deleted';