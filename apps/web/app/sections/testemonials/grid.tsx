...
export default ({ ...props }: ComponentProps<typeof Section>) => (
    <Section {...props}>
        ...
        <div className="overflow-hidden top-0 -ml-88 opacity-25 absolute flex blur-3xl">
            <div style={{ clipPath: "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" }} className="from-[#ff80b5] to-[#9089fc] rotate-30 bg-linear-to-tr aspect-1313/771 origin-right w-7xl"></div>
        </div>

        <div className=" blur-3xl overflow-hidden translate-z-0 -translate-y-1/2 opacity-30 top-1/2 inset-x-0 absolute">
            <div style={{ clipPath: "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" }} className="from-[#ff80b5] to-[#9089fc] bg-linear-to-tr ml-[max(50%,28rem)] aspect-1313/771 w-7xl"></div>
        </div>
