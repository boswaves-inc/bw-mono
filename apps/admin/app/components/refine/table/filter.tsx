...
import type { TableFilterDropdownProps, TableFilterDropdownActionsProps, TableFilterDropdownTextProps, TableFilterDropdownNumericProps, TableFilterComboboxProps, TableFilterDropdownDateSinglePickerProps, TableFilterDropdownDateRangePickerProps, TableFilterInputProps, TableFilterOperatorSelectProps } from "./types";
...
export function TableFilterDropdown<TData>({
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
                ...
                <Button
                    ...
                    className={cn(
                        ...
                        "w-5 h-5",
                        {
                            ...
                            "text-muted-foreground": !filtered,
                        },
                        triggerClassName
                    )}
                >
            ...
            >
                {children({ isOpen: open, setIsOpen: setOpen })}
            </PopoverContent>
        </Popover>
    );
}

export function TableFilterDropdownActions({
    className,
    isClearDisabled,
    isApplyDisabled,
    onClear,
    onApply,
}: TableFilterDropdownActionsProps) {
...
export function TableFilterDropdownText<TData>({
    column,
    table,
    operators = [
        "eq",
    ...
    defaultOperator = "eq",
    placeholder,
}: TableFilterDropdownTextProps<TData>) {
    const t = useTranslate();
...
export function TableFilterDropdownNumeric<TData>({
    column,
    table,
    operators = ["eq", "ne", "gt", "lt", "gte", "lte"],
    defaultOperator = "eq",
    placeholder,
}: TableFilterDropdownNumericProps<TData>) {
    const t = useTranslate();
...
export function TableFilterCombobox<TData>({
    column,
    table,
    options,
    defaultOperator = "eq",
    ...
    noResultsText,
    multiple = false,
}: TableFilterComboboxProps<TData>) {
    const t = useTranslate();
...
export function TableFilterDropdownDateSinglePicker<TData>({
    column,
    defaultOperator = "eq",
    formatDate,
}: TableFilterDropdownDateSinglePickerProps<TData>) {
...
export function TableFilterDropdownDateRangePicker<TData>({
    column,
    defaultOperator = "between",
    formatDateRange,
}: TableFilterDropdownDateRangePickerProps<TData>) {
    const columnFilterValue = column.getFilterValue() as string[];
...
export function TableFilterInput<TData>({
    ...
    return (
        <TableFilterDropdown column={columnFromProps}>
            {({ setIsOpen }) => {
                return (
                    <div
                        className={cn(
